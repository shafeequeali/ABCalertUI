...
export class ProcessedContentComponent implements OnInit {
  ...
  constructor(public alertService: AlertsService, private uploadService: UploadService) { }
  ...
  loadAlertData() {
    ...
    let t: any = [];
    this.uploadService.downLoadData('http://localhost:3000/alert?alert_status=PROCESSED')
      .subscribe((data: any) => {
        ...
        this.structure = t;
        console.log({ tag: this.TAG + ' subscribe', structure: this.structure, });
      })
